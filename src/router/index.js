...
import CropInformationComponent from "../crops/crop-information/pages/crop-information.component.vue";


const routes = [
    { path: '/', redirect: '/home'},
    { path:'/crop-list-and-registration',component: CropListAndRegistrationManagementComponent},
    { path: '/crop-information', component: CropInformationComponent},
