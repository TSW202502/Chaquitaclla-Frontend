...
import logoImage from '../../assets/images/ChaquitacllaLogoNuevo-no-bg.png';
...
export default {
  ...
  computed: {
    isFormValid() {
      return this.username && this.password && !this.usernameError && !this.isLoading;
    }
  },
  methods: {
    async onSignIn() {
      this.validateUsername();
      if (this.usernameError || !this.password) {
  ...
  <div class="login-container">
    <div class="left-section">
      <div class="brand-header">
        <img :src="logoImage" alt="Chaquitaclla" class="brand-logo" />
      </div>
      ...
      <div class="hero-content">
        <div class="hero-image-container">
          ...
          <div class="hero-text-overlay">
            <h1 class="overlay-title">Cultiva el Futuro</h1>
            <p class="overlay-subtitle">Tecnología que hace crecer tus sueños</p>
          </div>
        </div>
      </div>
          ...
          <div class="input-group">
            ...
            <div class="input-wrapper">
              ...
              <pv-password
                  ...
                  :class="{ 'input-error': errorMessage && !usernameError }"
                  placeholder="••••••••"
                  toggle-mask
                  :feedback="false"
                  @input="errorMessage = ''"
